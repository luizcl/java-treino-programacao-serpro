...
class SistemaBancarioTest {
    ...
    public void testMock(){
        ...
        assertEquals(123L, sistemaBancario.registrarBanco(new Banco("AAA")));
        ...
        assertThrows(BancoNaoCadastradoException.class, 
            () -> sistemaBancario.registrarBanco(new Banco("Santander")), "Banco não cadastrado");
    }
}